...
Porting `R` core is a daunting task, we want to _VERIFY_ fidelity with `R` on
...
1. [Uniform Pseudo Random Number Generators](#1-uniform-pseudo-random-number-generators)
2. [Normal distributed Random Number Generators](#2-normal-distributed-random-number-generators)
3. [Probability Distributions](#3-probability-distributions)
4. [Special Functions](#4-special-functions)
5. [Work Done](#5-work-done)
6. [Road Map](#6-road-map)

# 1. Uniform Pseudo Random Number Generators.
...
## 2. Normal distributed Random Number Generators.
