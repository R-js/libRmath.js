...
describe('gamma', function () {
    ...
    it('30, 35, 40, 45, 50', () => {
        expect([30, 35, 40, 45, 50].map(gamma)).toEqualFloatingPointBinary([
            8.8417619937397007727e30, 2.9523279903960411956e38, 2.0397882081197441588e46, 2.6582715747884485291e54,
            6.0828186403426752249e62
        ]);
    });
    it('130, 135, 140, 145, 150', () => {
        expect([130, 135, 140, 145, 150].map(gamma)).toEqualFloatingPointBinary([
            4.9745042224770297777e217, 1.9929427461617248218e228, 9.6157231969405526369e238, 5.5502938327392392576e249,
    ...
    it('-50.5, -1.000000000000004, -55.000000000000004', () => {
        expect([-50.5, -1.000000000000004, -55.000000000000004].map(gamma)).toEqualFloatingPointBinary([
            -1.4499543939077312447e-65, 2.5019997929836046875e14, 1.1082563917023920068e-59
        ]);
        //gamma([55]);
    });
});
