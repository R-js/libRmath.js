...
export function K_bessel(x: number, alpha: number, nb: number, ize: number): IBesselRC {
    ...
    */
    ...
    /*---------------------------------------------------------------------
      ...
      by W. J. Cody, 2/26/82 */
    const p = [
        0.805629875690432845, 20.4045500205365151, 157.705605106676174, 536.671116469207504, 900.382759291288778,
        730.923886650660393, 229.299301509425145, 0.822467033424113231
    ];
    const q = [
        29.4601986247850434, 277.577868510221208, 1206.70325591027438, 2762.91444159791519, 3443.74050506564618,
        2210.63190113378647, 572.267338359892221
    ];
    /* R, S - Approximation for (1-ALPHA*PI/SIN(ALPHA*PI))/(2.D0*ALPHA) */
    const r = [
        -0.48672575865218401848, 13.079485869097804016, -101.96490580880537526, 347.65409106507813131,
    ...
    const t = [
        1.6125990452916363814e-10, 2.5051878502858255354e-8, 2.7557319615147964774e-6, 1.9841269840928373686e-4,
        0.0083333333333334751799, 0.16666666666666666446
    ];
    /*---------------------------------------------------------------------*/
